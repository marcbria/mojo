 ...
 * Common site header.
 *
 * MBR: Different CSS in special pages.
 * MBR: Remove title at homepage.
 *
 **}
{strip}
...
<head>
	...
	{* <link rel="stylesheet" href="{$baseUrl}/styles/headerRedi.css" type="text/css" /> *}

        {* DEBUG:  
<!-- MBR: { $pageTitle } -->  *}
	{assign var="rediPage" value=$pageTitle|explode:"."}
	{if $rediPage[0] == 'user' ||
	    $rediPage[0] == 'admin' ||
	    $rediPage[0] == 'journal' ||
	    $pageTitle == 'plugins.generic.counter' ||
	    $pageTitle == 'common.languages' ||
	    $pageTitle == 'about.aboutSite' ||
	    $pageTitle == 'navigation.search'}
		<link rel="stylesheet" href="{$baseUrl}/plugins/themes/rediOaid/rediOaid.css" type="text/css" />
	{/if}
...
<!-- ReDi Google Analytics -->
{literal} 
<script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-24298149-1']);
  _gaq.push(['_setDomainName', '.uab.cat']);
...
<div id="header">
{* include file="common/header_REDI.tpl" *}
<div id="headerTitle">
<h1>
...
{* MBR: Condition to hide title at homepage *}
